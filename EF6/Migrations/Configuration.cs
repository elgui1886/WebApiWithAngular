namespace EF6.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EF6.WebApiContext>
    {
        ...
        protected override void Seed(EF6.WebApiContext context)
        {
            ...
            artists.ForEach(x => context.Artists.AddOrUpdate(x));
            context.SaveChanges();
