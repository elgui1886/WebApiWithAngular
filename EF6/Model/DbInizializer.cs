...
namespace WebApiWithAngular.Model
{
    public static class DbInizializer
    {
        public static void Inizialize(WebApiContext webApiContext)
        {

            if (webApiContext.Albums.Any())
            {
                return; // il database è stato istanziato
            }
            ...
            {
                webApiContext.Genres.Add(genre);
            }
            ...
            artists.ForEach(x => webApiContext.Artists.Add(x));
            webApiContext.SaveChanges();
            ...
            }.ForEach(a => webApiContext.Albums.Add(a));
